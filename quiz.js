          ...
          */
          ...
          if (i === 12) {
            ...
            function checkScoreFn() {
              ...
              scoreDiv.innerHTML = `<p class="heading"> Your Score </p> <p class="scoreNum">${score}/12</p> <br><p class="msg" style="color: ${color};"> ${message}</p> <br> <br> <button class="btn btn-reload">Redo Quiz</button><span> Github: https://github.com/ananth-0408`;
