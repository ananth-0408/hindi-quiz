          ...
          */
          ...
          if (i === 12) {
            ...
            function checkScoreFn() {
              ...
              scoreDiv.innerHTML = `<p class="heading"> Your Score </p> <p class="scoreNum">${score}/10</p> <br><p class="msg" style="color: ${color};"> ${message}</p> <br> <br> <button class="btn btn-reload">Redo Quiz</button>`;
